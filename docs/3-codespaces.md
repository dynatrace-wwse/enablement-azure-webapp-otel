...
Apps are accessible via the nginx ingress controller. The URL is shown in the greeting — run `printGreeting` in the terminal to display all app links. You can also make endpoints publicly accessible from VS Code's Ports panel.
